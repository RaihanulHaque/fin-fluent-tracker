...
import { User, Edit, Bell, Shield, Palette, Download, Trash2, Settings } from 'lucide-react';
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Get notified when you add new expenses</p>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Get detailed monthly expense reports</p>
                </div>
                <Switch
